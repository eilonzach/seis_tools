function [lgc]=isstring_seizmo(str)
%isstring_seizmo    True for a string (row vector) of characters
%
%    Usage:    lgc=isstring_seizmo(str)
%
%    Description:
%     LGC=isstring_seizmo(STR) returns TRUE if STR is a string (ie row vector) of
