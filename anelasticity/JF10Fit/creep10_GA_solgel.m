...
%  this is Multiple Sol Gel only (line m Table 2 JF10)
%  this line:  fixes mV=3 (creep d^mV) and fits peak
ma = 0.887; deltaB=1.91; alpha=.301; tauMo=1.32E6; 
EB=3.48E5; deltaP=.072; tauPo=1.995E-4; gsr=4.8E-6;
% MORE TESTS:  Just test PARTS of this
%ma=0.887;deltaB=1.91;
